...
public class SignUpExtracter extends  Extracter{
    ...
    //constructor
    public SignUpExtracter(String firstname, String lastname, String email, String password, int age, int career, int income, String bank_id, int bank_name) {
